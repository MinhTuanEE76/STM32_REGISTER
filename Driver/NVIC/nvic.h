...
// ====================== IRQn_Type - Full List for STM32F407 ======================
...
typedef enum {
    ...
    /******  STM32F407 specific Interrupt Numbers *******************************/
    ...
    TIM1_TRG_COM_TIM11_IRQn     = 26,     /* TIM1 Trigger and Commutation and TIM11 global Interrupt */
...
#define NVIC			((volatile NVIC_TypeDef_t*)0xE000E100UL)
